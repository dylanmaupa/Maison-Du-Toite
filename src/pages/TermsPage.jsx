    ...
    return (
        <main>
            ...
            <section className="section container" style={{ maxWidth: 780, marginTop: 'var(--space-xl)' }}>
                {[
                    { h: 'Acceptance of Terms', p: 'By placing an order with Maison du Toite, you agree to these terms and conditions in full. If you do not agree, please do not use our service.' },
                    ...
                    { h: 'Intellectual Property', p: 'All content on this site including photography, copy, and branding is the property of Maison du Toite. Reproduction without written permission is prohibited.' },
